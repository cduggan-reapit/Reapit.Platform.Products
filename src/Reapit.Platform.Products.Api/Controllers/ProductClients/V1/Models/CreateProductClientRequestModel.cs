...
/// <param name="CallbackUrls">Collection of URLs whitelisted for use as a callback to the client after authentication (authorization_code clients only).</param>
/// <param name="SignOutUrls">Collection of URLs that are valid to redirect to after logout. Wildcards are allowed for subdomains (authorization_code clients only).</param>
